...
//const char* ssid = "Kuzhiyadithazhath";
//const char* password = "geethuyadu1991";
//const char* serverName = "http://xiotasgreenhouse.hopto.org/SQL Server/sensordata.php";
//const char* serverName = "192.168.10.6/SQL Server/sensordata.php";

DHT sensor0(34, DHT11);DHT sensor1(35, DHT11);DHT sensor2(32, DHT11);DHT sensor3(33, DHT11);DHT sensor4(25, DHT11);DHT sensor5(26, DHT11);DHT sensor6(27, DHT11);
...
//RTC Clock variables
int Year = 0; int old_Year = 1;
int Month = 0; int old_Month = 1;
int Day = 0; int old_Day = 1;
int Hour = 0; int old_Hour = 1;
int Minute = 0; int old_Minute = 1;
int Second = 0; int old_Second = 1;
