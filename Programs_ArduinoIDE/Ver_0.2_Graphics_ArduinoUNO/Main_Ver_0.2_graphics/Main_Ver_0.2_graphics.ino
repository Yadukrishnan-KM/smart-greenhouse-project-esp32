...
{
 case 1:
  Homescreen (45, 20, 8.5, 3, LOW, HIGH, LOW, HIGH);
...
void homeTouchDetection()                    
{
  if (ts.touched())
  {
    ...
    {
     phscreen_count = LOW;
     pre_phs1d=0; pre_phs2d =0; pre_phs3d =0; pre_phs4d =0; pre_phs5d =0; pre_phs6d =0; pre_phs7d =0; pre_phs =0; 
     phs1dcount = LOW; phs2dcount = LOW; phs3dcount = LOW; phs4dcount = LOW; phs5dcount = LOW; phs6dcount = LOW; phs7dcount = LOW; 
     menu_window =4; 
    }
